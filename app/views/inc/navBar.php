<nav class="navbar navbar-expand-lg navbar-light  pe-3 ps-3">
    <div class="container-fluid">
          <a class="navbar-brand mx-auto " href="#"><img src="<?php echo URLROOT ?>./img/train_white.svg" height="48" alt=""></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo URLROOT; ?>/users/userProfile">Profile</a>
          </li>
          <?php endif; ?>
